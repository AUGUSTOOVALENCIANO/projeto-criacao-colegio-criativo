...
$query = $pdo->query("SELECT * FROM usuarios WHERE id_login = '$id_usuario'"); //criando login caso nao tenha nenhum
			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-book"></span>Criativo<span class="dashboard_text">Requerimentos</span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=usuarios"><i class="fa fa-angle-right"></i> Cadastrar/Consultar</a></li>
